...
write_mode = dag_configs["write_mode_complete"]
...
t_clear_bucket >> t_clear_local_folder >> t_download_epc >> t_unzip_epc >> t_stream_epc_to_bucket >> t_stream_ppd_to_bucket